        ...
        <div className="max-w-7xl mx-auto px-6">
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.div variants={fadeUp} className="text-gray-700 max-w-4xl space-y-8">
              ...
              <motion.div 
                variants={fadeUp}
                className="mt-16 p-8 md:p-12 bg-primary rounded-3xl text-center text-white shadow-2xl relative overflow-hidden"
              >
                {/* Decorative background element */}
                <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white/10 rounded-full blur-2xl"></div>
                
                <h2 className="text-3xl font-bold mb-4 relative z-10">Step Into Our World</h2>
                <p className="text-blue-100 mb-8 max-w-2xl mx-auto relative z-10">
                  Ready to connect with 2,000+ changemakers? Join our official WhatsApp community to stay updated on opportunities, events, and collaborative projects.
                </p>
                <a 
                  href="https://chat.whatsapp.com/IX5atzce9Nn06d0nXesjwU" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-lg relative z-10"
                >
